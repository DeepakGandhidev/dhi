...
export const metadata: Metadata = {
  title: "The plan",
  description:
    "How DHI pays: direct sponsorship from 25% to 50%, a 25 PV binary match to the fifth generation, the Fast Cumulation at 254 people, and personal purchase discounts.",
};
      ...
      <section className="section" id="generations">
        <div className="shell">
          <div className={styles.head}>
            ...
            <p className="lede">
              Two, four, eight, all the way to a hundred and twenty-eight. The binary bonus is
              paid through eight generations, you included — {NETWORK_BELOW} people below you, {NETWORK_TOTAL} positions
              counting your own.
            </p>
          </div>
          <Generations />
          ...
          <div className={styles.fast}>
            ...
            <div>
              ...
              <p style={{ color: "#b9c0e6", fontSize: "var(--t-s)" }}>
                A milestone of its own, separate from the binary: the structure complete to the end of the eighth generation,{" "}
